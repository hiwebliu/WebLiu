<div class="user_links">
	...
	<?php if (webliu_option('social_weixin')) { ?>
		<a class="social_weixin" href="javascript:void(0);" target="_blank" data-toggle="tooltip" title="关注我的微信" rel="nofollow"><i class="fa fa-weixin"></i>
		<div class="social_weixin_img">
			<h4>扫一扫，关注我</h4>
			<img src="<?php echo webliu_option('social_weixin'); ?>">
		</div>
		</a>
	<?php } ?>
	<?php if (webliu_option('social_github')) { ?>
		<a class="social_github" href="<?php echo webliu_option('social_github'); ?>" target="_blank" data-toggle="tooltip" title="关注我的github" rel="nofollow"><i class="fa fa-github"></i></a>
	<?php } ?>
